...
public class G_UtilityWorldStateEditor : Editor
{
        ...
        List<string> missingU_ValueNames)
    {
        ...
        {
            TestForUtilitiesInWorldState(worldRef, utilityGoal.UtilityScorer.values, missingU_ValueNames);
        }
    }
    ...
    void TestForUtilitiesInWorldState(G_UtilityWorldState worldRef,
        List<U_Value> values,
        List<string> missingU_ValueNames)
    {
        ...
        List<string> missingStateNames)
    {
        ...
        if (foundValue == null)
        {
            AddToMissingNameList(missingStateNames, value.name);
        }
    }
