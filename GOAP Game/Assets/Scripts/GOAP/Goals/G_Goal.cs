...
namespace GOAP
{
    ...
    public class G_Goal : ScriptableObject
    {
        ...
        public void Construct(string name, List<G_Condition> triggerConditions, List<G_Condition> goalEffects, int priority = 0)
        {
            this.name = name;
        ...
        public virtual G_Goal Clone()
        {
            ...
            clonedGoal.Construct(this.name, clonedTriggers, clonedEffects, this.priority);
            return clonedGoal;
        }
