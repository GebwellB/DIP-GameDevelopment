...
namespace UtilityAI
{
    ...
    public class U_Value : ScriptableObject
    {
        ...
        public U_ValueSource VarSource
        { get { return varSource; } }

        public U_ValueSource MaxSource
        { get { return maxSource; } }

        public G_FloatState FloatStateVar
        { get { return floatStateVar; } }

        public G_FloatState FloatStateMax
        { get { return floatStateMax; } }

        public G_IntState IntStateVar
        { get { return intStateVar; } }

        public G_IntState IntStateMax
        { get { return intStateMax; } }

        public U_Value UtilityVar
        { get { return utilityVar; } }
        ...
        {
            this.name = name;
            this.responseCurve = resonseCurve;
