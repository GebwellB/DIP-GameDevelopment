...
public class FloatStateTests
{
    ...
    [TestCase(5f, G_StateComparison.greater_or_equal, 5, true, TestName = "Greater or Equal - Equal Test Value")]
    ...
    [TestCase(5f, G_StateComparison.lesser_or_equal, 5, true, TestName = "Lesser or Equal - Equal Test Value")]
    [TestCase(5f, G_StateComparison.lesser_or_equal, 6, true, TestName = "Lesser or Equal - Greater Test Value")]
    public void TestState(float stateValue,
